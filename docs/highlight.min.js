/*!
  Highlight.js v11.11.1 (git: 0af003653a)
...
},M=x("//","$"),A=x("/\\*","\\*/"),S=x("#","$");var C=Object.freeze({
...
return n?Number(n):(e=>$.includes(e.toLowerCase()))(e)?0:1}const P={},j=e=>{
...
const V=t,Y=a,J=Symbol("nomatch"),ee=t=>{
...
const l=Object.create(null);function c(){if(!x.keywords)return void A.addText(S)
...
return 0===x.matcher.regexIndex?(S+=e[0],1):(D=!0,0)}function h(e){
const n=e[0],a=t.substring(e.index),i=m(x,e,a);if(!i)return J;const r=x
;x.endScope&&x.endScope._wrap?(d(),
g(n,x.endScope._wrap)):x.endScope&&x.endScope._multi?(d(),
u(x.endScope,e)):r.skip?S+=n:(r.returnEnd||r.excludeEnd||(S+=n),
d(),r.excludeEnd&&(S=n));do{
x.scope&&A.closeNode(),x.skip||x.subLanguage||(C+=x.relevance),x=x.parent
}while(x!==i.parent);return i.starts&&b(i.starts,e),r.returnEnd?0:n.length}
let y={};function N(a,r){const o=r&&r[0];if(S+=a,null==o)return d(),0
...
;throw e.mode=x,e}if("end"===r.type){const e=h(r);if(e!==J)return e}
...
;const O=W(w);let k="",x=r||O;const M={},A=new p.__emitter(p);(()=>{const e=[]
;for(let n=x;n!==w;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>A.openNode(e)))})();let S="",C=0,T=0,R=0,D=!1;try{
if(w.__emitTokens)w.__emitTokens(t,A);else{for(x.matcher.considerAll();;){
...
value:k,relevance:C,illegal:!1,_emitter:A,_top:x}}catch(n){
...
language:e,value:V(t),illegal:!1,relevance:0,errorRaised:n,_emitter:A,_top:x}
...
}},i={$pattern:me,keyword:pe,literal:_e,built_in:Ne,"variable.language":ye
...
className:"title.class",keywords:{_:[...he,...fe]}},N={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[f],
illegal:/%/},w={
match:n.concat(/\b/,(v=[...Ee,"super","import","await"].map((e=>e+"\\s*\\(")),
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ue,r]}},grmr_javascript:we,
...
;const v=[y,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g,h],O={
...
contains:["self",...v]},...v,{scope:"meta",variants:[{match:i},{match:r}]}]}
...
contains:["self",O,s,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g]
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,m(...Oe,...ke)],
className:{2:"keyword"}},r={match:b(/\./,m(...Me)),relevance:0
},s=Me.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Me.filter((e=>"string"!=typeof e)).concat(xe).map(ve),...ke)}]},l={
...
scope:{1:"keyword",3:"keyword"}},P,z,U,{beginKeywords:"import",end:/$/,
contains:[...a],relevance:0},A,...c,...g,...p,f,O,...C,...T,R,I]}},
grmr_typescript:e=>{
const n=e.regex,t=we(e),a=me,i=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],r={
...
literal:_e,built_in:Ne.concat(i),"variable.language":ye},l={className:"meta",
...
}]}},grmr_xbase:e=>({name:"xBase",aliases:["clipper","harbour","xharbour"],
keywords:{
keyword:"#include #define if endif ifdef ifndef define return procedure function local public private static do while enddo for next switch endswitch case otherwise endcase class endclass method endtext begin sequence recover break try catch finally endtry declare request use index set clear typedef parameters with object endwith",
literal:".T. .F. NIL TRUE FALSE",
built_in:"chr len str val substr left right upper lower alert alltrim ltrim rtrim space trim date time seconds dow dtoc ctod dtos stod AADD ABS ACLONE ADIR AEVAL AFIELDS ALERT ASC ASCAN ASIZE ASORT AT ATAIL BOF CDOW CMONTH COL COLORSELECT CTOD DATE DAY DBAPPEND DBCLOSEALL DBCLOSEAREA DBCOMMITALL DBDELETE DBEDIT DBEVAL DBFILTER DBGOBOTTOM DBGOTO DBGOTOP DBRECALL DBREINDEX DBRELATION DBRLOCK DBRLOCKLIST DBRUNLOCK DBSEEK DBSETFILTER DBSETINDEX DBSETORDER DBSETRELATION DBSKIP DBSTRUCT DBUNLOCK DBUNLOCKALL DBUSEAREA DELETED DESCEND DEVOUT DIR DIRECTORY DISKSPACE DISPBEGIN DISPBOX DISPCOUNT DISPEND DISPLAY DISPOUT EMPTY EOF EVAL EXP FCLOSE FCREATE FIELDS FILE FOPEN FREAD FWRITE FSEEK FLOCK FRENAME FERROR FOUND GETENV HARDCR HEADER INDEXKEY INDEXORD INKEY INT ISALPHA ISDIGIT ISLOWER ISPRINTER ISUPPER LASTKEY LEN LOG LOWER LTRIM MAX MIN MEMOEDIT MEMOREAD MEMOWRIT MEMVARBLOCK MOD MONTH NETERR NETNAME ORDSETFOCUS OUTERR PCOUNT PROCNAME QOUT QQOUT RANDOM RAT RDDNAME RDDREGISTER RDDSETDEFAULT READ RECNO RECSIZE REPLICATE RIGHT RLOCK ROUND ROW RTRIM SAVESCREEN SCROLL SECONDS SELECT SET SETBLINK SETCURSOR SETKEY SPACE SQRT STR STRTRAN STRZERO STUFF SUBSTR SUM TIME TRANSFORM TYPE UPDATED UPPER USED VAL VALTYPE VERSION YEAR"
},
contains:[e.COMMENT(/\/\/.*/,"$"),e.COMMENT(/\/\*/,/\*\//),e.QUOTE_STRING_MODE,e.NUMBER_MODE]
}),grmr_xml:e=>{
...
aliases:["yml"],contains:l}}});const je=ne;for(const e of Object.keys(Pe)){
const n=e.replace("grmr_","").replace("_","-");je.registerLanguage(n,Pe[e])}
return je}()
